...
function authenticate() {
    respond('', 401, [
        'WWW-Authenticate: Basic realm="Login to Myriad M-SODAS Retest CSV Upload URL"'
    ]);
}
...
<head>
  <title>M-SODAS再検査管理レコードCSVアップロード</title>
    ...
    <div class="container grid-lg">
          <div class="columns">
              <div class="column col-10">
                ...
                <h1 class="text-error mt-4">M-SODAS再検査管理レコード作成</h1>
              <p>当URLは、再検査管理データの入った、決まった形式のCSVを受け付けて、様々な変換してからM-SODAS PROdbにアップロードします。</p>
              <br>
              <!-- form input control -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-9 col-sm-12">
                    <div class="input-group">
                      ...
                      <button class="btn btn-error input-group-btn c-hand btn-lg" type="submit" id="submit">CSV送信</button>
                    </div>
                  </div>
                </div>
...
csv_nozero1 = string_replace(csv_content,"0","ZZEERROO");
csv_nozero = string_replace(csv_nozero1,"ID-ZZEERROO","ID-0");
