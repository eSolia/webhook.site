// Call from github
//result = import('https://raw.githubusercontent.com/RickCogley/webhook.site/master/PROdb/mgj-load-csv-01c.js')
//echo(result)
	  ...
	  <div class="container grid-lg">
			<div class="columns">
				...
				<header class="navbar bg-gray p-2 my-2">
				 ...
				 <h1 class="text-success mt-4">CSVアップロード完了</h1>
				 ...
				 <br>
				 <p><button class="btn btn-success c-hand"><a href="{}" class="text-light">別のCSVアップロードする</a></button></p>
