...
<head>
  <title>M-SODAS新規外部ユーザーCSVアップロード</title>
    ...
    <div class="container grid-lg">
          <div class="columns">
              <div class="column col-10">
                ...
                <h1 class="text-success mt-4">M-SODAS新規外部ユーザー作成</h1>
              <p>当URLは、新規ユーザーデータの入った、決まった形式のCSVを受け付けて、様々な変換してからM-SODAS PROdbにアップロードします。</p>
              <br>
              <!-- form input control -->
